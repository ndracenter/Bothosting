...
CFonts.say("SC PAIRING BY FERDYNESIA", {
   font: 'chrome',
  align: 'left',
  gradient: ['red', 'magenta'],
});
CFonts.say(
  "Sc Bot By Ndra\nBase: Ori NdraCloudHost\nRecodeBy: NdraCloudHost\ncampuran\nRuning:Panel\n\n\nSc Ini Di Recode NdraCloudHost Kalo Kethauan Jual Murah Sc inI gua Banned Nyawa Lu Jarak Jauh\n\n\n",
  {
    colors: ["system"],
    font: "console",
    align: "center",
